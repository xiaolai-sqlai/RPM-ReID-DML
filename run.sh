...
# vis
# python vis_market1501.py --net regnet_y_1_6gf --decoder rpm_max --img-height 384 --img-width 128 --batch-size 32 --gpus 0 --dataset-root /dev/shm --num-part 2 --feat-num 256 --use-global True --weight 1
