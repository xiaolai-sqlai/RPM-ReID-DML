...
if __name__ == '__main__':
    ...
    if "rpm" in opt.decoder:
        net = RPM(decoder=opt.decoder, num_classes=11318, num_part=opt.num_part, feat_num=opt.feat_num, net=opt.net, h=opt.img_height//16, w=opt.img_width//16, use_global=opt.use_global)
    elif "pcb" in opt.decoder:
        net = PCB(decoder=opt.decoder, num_classes=11318, num_part=opt.num_part, feat_num=opt.feat_num, net=opt.net, h=opt.img_height//16, w=opt.img_width//16, use_global=opt.use_global)
